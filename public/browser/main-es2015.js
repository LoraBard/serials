...
let DetailComponent = class DetailComponent {
    ...
    ngOnInit() {
        this.homeService.getCertainShow(this.route.snapshot.params['id']).subscribe(shows => {
            ...
            this.isSubscribed = this.show.subscribers.includes(this.user);
        });
        this.authService.email.subscribe((email) => {
...
let HomeComponent = class HomeComponent {
    constructor(homeService, router, authService) {
        this.homeService = homeService;
        this.router = router;
        this.authService = authService;
...
let LoginComponent = class LoginComponent {
    ...
    singInGoogle(platform) {
        ...
        this._socioAuthServ.signIn(platform).then((response) => {
            ...
            this.authService.SignInGoogle({ id: Object(lodash__WEBPACK_IMPORTED_MODULE_6__["uniqueId"])(), email: this.user.email });
...
let MyShowsComponent = class MyShowsComponent {
    ...
    ngOnInit() {
        this.homeService.getUsersShows({ user: this.user }).subscribe(shows => {
            this.shows = shows.body;
            console.log('USERS_SHOWS', this.shows);
        });
    }
};
...
let SignupComponent = class SignupComponent {
    constructor(authService, router, routingState) {
        this.authService = authService;
        this.router = router;
        this.routingState = routingState;
        this.passwordText = '';
