(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddComponent = /** @class */ (function () {
                ...
                AddComponent.prototype.addShow = function () {
                    var _this = this;
                    this.homeService.postShows(this.showName).subscribe(function (count) {
                        _this.count = count;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DetailComponent = /** @class */ (function () {
                ...
                DetailComponent.prototype.isSubscribers = function () {
                ...
                DetailComponent.prototype.ngOnInit = function () {
                    ...
                    this.homeService.getCertainShow(this.route.snapshot.params['id']).subscribe(function (shows) {
                        ...
                        _this.isSubscribed = _this.isSubscribers();
                        console.log('IS', _this.isSubscribed);
                    });
                    this.authService.email.subscribe(function (email) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                function HomeComponent(homeService, router, authService, routingState) {
                    this.homeService = homeService;
                    this.router = router;
                    this.authService = authService;
            ...
            var LoginComponent = /** @class */ (function () {
                ...
                LoginComponent.prototype.singInGoogle = function (platform) {
                    ...
                    this._socioAuthServ.signIn(platform).then(function (response) {
                        ...
                        _this.authService.login({ email: response.email, password: '' });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MyShowsComponent = /** @class */ (function () {
                ...
                MyShowsComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    var usersFilms = [];
                    this.homeService.getUsersShows({ user: this.user }).subscribe(function (show) {
                        usersFilms = show.body;
                        console.log('USERS_SHOWS', usersFilms);
                        usersFilms.map(function (item) {
                            var s = _this;
                            console.log(s);
                            _this.homeService.getCertainShow(item).subscribe(function (sho) {
                                console.log(s.shows);
                                s.shows.push(sho.body);
                                console.log('MYYYYYYYYYYYYYY', _this.shows);
                            });
                        });
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SignupComponent = /** @class */ (function () {
                function SignupComponent(authService, router, routingState, _socioAuthServ) {
                    this.authService = authService;
                    this.router = router;
                    this.routingState = routingState;
                    this._socioAuthServ = _socioAuthServ;
                ...
                SignupComponent.prototype.PasswordValidator = function (control) {
                    if (/^(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!%*#?&]{8,}$/.test(control.value)) {
                        return { "signupForm": true };
                    }
                    return null;
                };
                SignupComponent.prototype.singInGoogle = function (platform) {
                    var _this = this;
                    ...
                    this._socioAuthServ.signIn(platform).then(function (response) {
                        ...
                        console.log(platform + " logged in user data is= ", response);
                        _this.authService.Signup({ email: response.email, password: '' });
                        _this.authService.setUserEmail(response.email);
                        _this.router.navigate(["" + _this.previousRoute]);
                    }, function (reject) {
